...
function Dashboard() {
  return (
    <div>
      {/* <!-- component --> */}
<div class="font-sans bg-grey-lighter flex flex-col min-h-screen max-w-screen">
  <div>
      ...
      <div class="container mx-auto px-4">
        <div class="md:flex">
          <div class="flex -mb-px mr-8">
            <Link href="#" class="no-underline text-white md:text-blue-dark flex items-center py-4 border-b border-blue-dark">
          ...
          <div class="flex -mb-px mr-8">
            <Link href="#" class="no-underline text-white opacity-50 md:text-grey-dark md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-grey-dark">
    ...
    <div class="container mx-auto px-4">
      <div class="md:flex justify-between items-center text-sm">
        <div class="text-center md:text-left py-3 md:py-4 border-b md:border-b-0">
          <Link href="#" class="no-underline text-grey-dark mr-4">Home</Link>
          <Link href="#" class="no-underline text-grey-dark mr-4">Careers</Link>
          <Link href="#" class="no-underline text-grey-dark">Legal &amp; Privacy</Link>
        </div>
        <div class="md:flex md:flex-row-reverse items-center py-4">
          <div class="text-center mb-4 md:mb-0 md:flex">
            ...
            <div>
              <Link href="#" class="inline-block leading-tight bg-blue border border-blue-dark hover:bg-blue-dark px-3 py-2 text-white no-underline rounded">Need help?</Link>
            </div>
          </div>
